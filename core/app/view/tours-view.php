						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h1 class=""> Tours</h1>
									<a href="./?view=tours&opt=new" class="btn btn-secondary">Nuevo  Tours</a>
								</div>
								<div class="card-body">
											...
											<?php foreach($contacts as $con):?>
												<tr>
													...
													<td style="width:160px; ">
														<a href="./?view=tours&opt=edit&id=<?php echo $con->id; ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Editar</a>
														<a href="./?action=tours&opt=del&id=<?php echo $con->id; ?>" id="item-<?php echo $con->id; ?>"  class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Eliminar</a>
														<script type="text/javascript">
															$("#item-<?php echo $con->id; ?>").click(function(e){
																e.prtourDefault();
																x = confirm("Seguro desea eliminar este elemento?");
																if(x){
																	window.location = "./?action=tours&opt=del&id=<?php echo $con->id; ?>";
																}
															});
														</script>
													</td>
									...
									<?php else:?>
										<p class="alert alert-warning">No hay  Tours.</p>
									<?php endif;?>
								</div>
							</div>
      ...
      <div class="container-fluid">
					<div class="row">
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h1 class="">Nuevo  Tours</h1>
									<a href="./?view=tours&opt=all" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Regresar</a>
								</div>
								<div class="card-body">

<form method="post" enctype="multipart/form-data" action="./?action=tours&opt=add">
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="email" class="form-control" id="fecha" placeholder="Email">
  </div>
  <div class="mb-3">
      ...
      <div class="container-fluid">
					<div class="row">
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h1 class="">Editar  Tours</h1>
									<a href="./?view=tours&opt=all" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Regresar</a>
								</div>
								<div class="card-body">

<form method="post" enctype="multipart/form-data" action="./?action=tours&opt=update">
