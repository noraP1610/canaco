...
class PersonData {
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (name,lastname,address,email,phone,created_at,image) ";
		$sql .= "value (\"$this->name\",\"$this->lastname\",\"$this->address\",\"$this->email\",\"$this->phone\",$this->created_at,\"$this->image\")";
		Executor::doit($sql);
	}
